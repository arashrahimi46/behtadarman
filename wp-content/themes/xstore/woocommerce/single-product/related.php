...
$related_type = etheme_get_option('related_type');
...
elseif ( $related_type == 'slider' ) {
	...
	if ( is_array($slides) ) {
		// large
		if ( !empty($related_slides['large']) ) $slider_args['large'] = $related_slides['large'];

		if ( !empty($related_slides['notebook']) ) $slider_args['notebook'] = $related_slides['notebook'];

		if ( !empty($related_slides['tablet_land']) ) $slider_args['tablet_land'] = $related_slides['tablet_land'];

		if ( !empty($related_slides['tablet_portrait']) ) $slider_args['tablet_portrait'] = $slider_args['mobile'] = $related_slides['tablet_portrait'];
	}
