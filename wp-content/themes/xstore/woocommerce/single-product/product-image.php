...
$et_zoom = etheme_get_option( 'product_zoom' ) && !isset($etheme_global['quick_view']); 
...
<?php if ( ! defined('DOING_AJAX') && ! isset($etheme_global['quick_view']) ): ?>
    <div class="swiper-entry swipers-couple-wrapper images images-wrapper with-pswp woocommerce-product-gallery arrows-hovered <?php if ( $vertical_slider && $gallery_slider && $attachment_ids ) echo'swiper-vertical-images'; ?>">
<?php endif;
...
if($gallery_slider && $show_thumbs) {
    ...
    if ( $attachment_ids || $has_video || $force_check ) {
        ...
        ?>
        <div class="<?php echo esc_attr($class); ?>" <?php if (!$vertical_slider) : ?>data-breakpoints="1" data-xs-slides="<?php echo ( etheme_get_option('responsive_slides') ) ? etheme_get_option('responsive_slides') : 3 ?>" data-sm-slides="<?php echo esc_attr( $res_slides ); ?>" data-md-slides="<?php echo esc_attr( $res_slides ); ?>" data-lt-slides="<?php echo esc_attr( $res_slides ); ?>" data-slides-per-view="<?php echo esc_attr( $res_slides ); ?>" data-clickedslide="1" data-spaceBetween="10" <?php endif;?>>
            <?php etheme_loader(); ?>
            <ul
