...
$element_options['product_tabs_type'] = etheme_get_option( 'product_tabs_type_et-desktop' );
$element_options['product_tabs_style'] = etheme_get_option( 'product_tabs_style_et-desktop' );
...
$element_options['product_tabs_closed'] = ( $element_options['product_tabs_type'] == 'accordion' && !etheme_get_option( 'product_first_tab_opened_et-desktop' ) );
$element_options['product_tabs_scroll'] = etheme_get_option( 'product_tabs_scroll_et-desktop' );
...
$element_options['product_tabs_navigation_align'] = etheme_get_option( 'product_tabs_navigation_align_et-desktop' );

$element_options['classes'] = 'type-'.$element_options['product_tabs_type'];
$element_options['classes'] .= ' ' . $element_options['product_tabs_style'];
