...
$upsell_location = etheme_get_option( 'upsell_location' );
...
if( $upsell_type == 'widget' ) {
	...
	if ( isset($upsell_slides['large']) && !empty($upsell_slides['large']) ) $slider_args['large'] = $upsell_slides['large'];

	if ( isset($upsell_slides['notebook']) && !empty($upsell_slides['notebook']) ) $slider_args['notebook'] = $upsell_slides['notebook'];

	if ( isset($upsell_slides['tablet_land']) && !empty($upsell_slides['tablet_land']) ) $slider_args['tablet_land'] = $upsell_slides['tablet_land'];

	if ( isset($upsell_slides['tablet_portrait']) && !empty($upsell_slides['tablet_portrait']) ) $slider_args['tablet_portrait'] = $slider_args['mobile'] = $upsell_slides['tablet_portrait'];
