<?php  
	...
	Kirki::add_section( 'footer-layout', array(
	    ...
	    'description' => esc_html__( 'Remember that you can create footer using static blocks.', 'xstore' ) . ' <a href="https://youtu.be/hmsxW5KF9dg" rel="nofollow" target="_blank">'.esc_html__('Watch the tutorial', 'xstore').'</a>.',
	    'panel' => 'footer',
