	...
	function etheme_base_metaboxes() {
	    ...
	    if ( !$etheme_header_builder ) {
		    ...
		    $cmb->add_field( array(
		            ...
		            'name'        => esc_html__('Custom logo for this page/post', 'xstore'),
	        ...
	        $cmb->add_field( array(
				'name'    => esc_html__('Custom header type', 'xstore'),
				'id'      => ETHEME_PREFIX . 'custom_header',
				'type'    => 'radio_inline',
				'desc'    => '<span>This option will be deprecated in theme version x.x.x ' . et_time_2_remove_header() . ' days until update</span>',
				'options' => array(
				...
				'default' => '',
				'classes' => 'et-image-metabox et_header-builder-timer',
			) );

		    $cmb->add_field( 
		        array(
		            'id'          => ETHEME_PREFIX .'header_overlap',
		            'name'        => esc_html__('Header overlap', 'xstore'),
		            'default'     => false,
		            'type'        => 'checkbox'
		        )
	    	);
		    ...
		    $cmb->add_field( 
		        array(
		            ...
		            'name'        => esc_html__('Header background color', 'xstore'),
				    'type' => 'colorpicker',
		        )
	    	);
	      	...
	      	$cmb->add_field( 
		        array(
		            ...
		            'name'        => esc_html__('Header transparent', 'xstore'),
		            'default'     => false,
		            'type'        => 'checkbox'
		        )
		 	);
		    ...
		    $cmb->add_field(array(
		            ...
		            'name'        => esc_html__('Header text color', 'xstore'),
		            'type'        => 'radio',
		            'options'     => array(
		                'inherit' => 'Inherit',
		                'dark' => 'Dark',
	    	...
	    	$cmb->add_field(array(
		            ...
		            'name'        => esc_html__('Top bar text color', 'xstore'),
		            'type'        => 'radio',
		            'options'     => array(
		                'inherit' => 'Inherit',
		                'dark' => 'Dark',
	   	...
	   	if ( !$etheme_header_builder ) {
		    $cmb->add_field( 
		        array(
		            ...
		            'name'       => esc_html__('Custom navigation', 'xstore'),
		            'type'        => 'select',
		    ...
		    $cmb->add_field( 
		        array(
		            ...
		            'name'       => esc_html__('Custom navigation right (for double menu header)', 'xstore'),
		            'type'        => 'select',
		            'options'     => etheme_get_menus_options()
		        )
	    	);
		    ...
		    $cmb->add_field( 
		        array(
		            ...
		            'name'       => esc_html__('Custom navigation for mobile', 'xstore'),
		            'type'        => 'select',
		            'options'     => etheme_get_menus_options()
		        )
	    	);
		    ...
		    $cmb->add_field( 
		        array(
		            ...
		            'name'        => esc_html__('One page navigation', 'xstore'),
		            'default'     => false,
		            'type'        => 'checkbox'
		        )
	    	);
    	...
    	$cmb->add_field( 
			array(
				'name' => esc_html__('Sale counter', 'xstore'),
	    ...
	    $cmb->add_field( 
			array(
			    'name' => esc_html__('Soundcloud audio shortcode (for audio post format)', 'xstore'),
