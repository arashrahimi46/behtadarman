jQuery(function() {
    ...
    if(dig_login_wp_elem.length) {
        ...
        if(dig_login_wp_elem.find(".loginuname").length===0) {
            ...
            dig_login_wp_elem.find("input[type='text']").first().attr('id', 'username');
        }else{
...
//// Ultimate user
    ...
    jQuery('.forgotcountrycode').bind("keyup change", function (e) {
        ...
        user_login.css({"padding-left": jQuery('.forgotcountrycode').outerWidth(true) + ew/2 + "px"}, 'fast', function () {});
    });
    ...
    register.find("input[type='submit'], .woocommerce-Button, button[name='register']").click(function (e) {
