...
class Title extends Shortcodes {
	...
	function title_shortcode( $atts, $content ) {
        ...
        $options['css'] = array(
            ...
            $options['selectors']['title_preudo'] => array(),
            'desktop' => array(),
			'tablet' => array(),
			'mobile' => array()
        );

   		$options['css'][$options['selectors']['title_preudo']][] = 'border-color: '.$atts['divider_color'].' !important';
   		$options['css'][$options['selectors']['title_preudo']][] = 'border-bottom-width: ' . $atts['divider_width'] . ' !important';
        ...
        $options['output_css'][] = $options['selectors']['title_preudo'] . '{'.implode(' ', $options['css'][$options['selectors']['title_preudo']]).'}';

        if ( count($options['css']['tablet']) ) 
        	$options['output_tablet_css'][] = implode(' ', $options['css']['tablet']);

        if ( count($options['css']['mobile']) ) 
        	$options['output_mobile_css'][] = implode(' ', $options['css']['mobile']);
