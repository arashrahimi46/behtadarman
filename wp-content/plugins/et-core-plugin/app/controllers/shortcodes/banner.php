...
class Banner extends Shortcodes {
	...
	public static function banner_shortcode( $atts, $content ) {
	    ...
	    $atts = shortcode_atts(array(
	        ...
	        'img' => '',
			'responsive_fonts' => 1, // @omid maybe try to add extra typography options for each part of content such as title, subtitle, button and content with responsive font-sizes, because this option as for me is not perfect 
		...
		$options['image'] = etheme_get_image($atts['img'], $options['size']);
