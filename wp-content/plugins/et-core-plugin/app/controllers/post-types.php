...
class Post_Types extends Base_Controller{
	...
	public function custom_type_settings() {
		 ...
		 *
		 */
		if( function_exists( 'etheme_get_option' ) && ( get_theme_mod('portfolio_projects', true) || get_theme_mod('enable_brands', true) ) ){
		 ...
		 *
		 */
		if ( class_exists('Woocommerce') && function_exists( 'etheme_get_option' ) && get_theme_mod('enable_brands', true) ) {
			add_settings_field(
				'brand_base',
