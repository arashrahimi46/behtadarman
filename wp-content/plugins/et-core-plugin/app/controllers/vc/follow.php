	...
	function register_follow() {
		...
		$params = array(
			...
			array(
				...
				'param_name' => 'size', // notice @omid - you can try to do it as radio buttons type if elementor has such field type 
				'value' => array(
			...
			array(
				...
				'param_name' => 'align', // notice @omid - you can try to do it as radio buttons type if elementor has such field type 
