		...
		$testimonials_params = array(
			...
			'params' => array(
				...
				array(
					...
					'images_value' => array(
						'slider'   => ET_CORE_SHORTCODES_IMAGES . '/testimonials/Slider.svg',
						'slider-grid'   => ET_CORE_SHORTCODES_IMAGES . '/testimonials/Slider-grid.svg',
						'grid'   => ET_CORE_SHORTCODES_IMAGES . '/testimonials/Grid.svg',
					),
					'et_tooltip' => true,
				),
                array(
