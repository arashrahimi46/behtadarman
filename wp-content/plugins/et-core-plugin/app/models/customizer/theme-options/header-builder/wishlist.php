<?php  
	...
	Kirki::add_section( 'wishlist', array(
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'output'	  => array(
				array(
					'element' => '.et_b_header-wishlist.et_element-top-level .et-mini-content .product_list_widget',
					'property' => 'color'
				)
			),
		) );
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'js_vars'     => array(
				array(
					'element'  => '.et_b_header-wishlist .et-close',
					'function' => 'toggleClass',
					'class' => 'full-right',
					'value' => 'right'
				),
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'output'      => array(
				array(
					'element' => '.et_b_header-wishlist .et-mini-content, .et_b_header-wishlist .cart-widget-products',
					'property' => 'border-color',
				),
			),
		) );
