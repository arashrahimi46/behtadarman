<?php  
	...
	Kirki::add_section( 'product_size_guide', array(
			...
			'partial_refresh' => array(
				'product_size_guide_icon_et-desktop' => array(
					...
					'render_callback' => function() {
						$type = get_theme_mod('product_size_guide_icon_et-desktop');
						$icons = array (
		...
		Kirki::add_field( 'et_kirki_options', array(
			...
			'description' => esc_html__( 'Description Here.', 'xstore-core' ),
			'section'     => 'product_size_guide',
		...
		// product_size_guide_popup_box_model
		Kirki::add_field( 'et_kirki_options', array(
