...
$element_options['icon_type_et-desktop'] = Kirki::get_option( 'product_size_guide_icon_et-desktop' );
$element_options['product_size_guide_align_et-desktop'] = ' justify-content-'.Kirki::get_option( 'product_size_guide_align_et-desktop' );
$element_options['product_size_guide_icons_et-desktop'] = array (
	...
	'custom' => Kirki::get_option( 'product_size_guide_icon_custom_et-desktop' ),
	'none' => ''
);
...
$element_options['product_size_guide_label_et-desktop'] = Kirki::get_option( 'product_size_guide_label_et-desktop' );
$element_options['product_size_guide_label_show_et-desktop'] = Kirki::get_option( 'product_size_guide_label_show_et-desktop' );
...
<div class="et_element single-product-size-guide align-items-center flex <?php echo $element_options['product_size_guide_align_et-desktop']; ?>" <?php echo implode( ' ', $element_options['attributes'] ); ?>>	
	<span class="pointer et-popup_toggle" data-type="size_guide" data-popup-on="click" data-id="<?php echo $element_options['product_id']; ?>" style="all: inherit; cursor: pointer;">
